      ...
      >
        ...
        <div className="absolute top-[60px] left-6 z-20 flex flex-col items-center gap-6 select-none">
          ...
          >
            <div className="w-20 h-20 flex items-center justify-center transition-all group-hover:drop-shadow-[0_0_15px_rgba(142,155,114,0.4)]">
              <img
                src="/images/contact_optimized.webp"
                alt="Contact"
                loading="eager"
                fetchPriority="high"
                className="w-full h-full object-contain pointer-events-none select-none"
          ...
          <motion.div
            ...
            className="flex flex-col items-center gap-0 cursor-pointer group"
          >
            <div className="w-20 h-20 flex items-center justify-center transition-all group-hover:drop-shadow-[0_0_15px_rgba(74,222,128,0.4)]">
              <img
                src="/images/skills_optimized.webp"
                alt="Skills"
                loading="eager"
                fetchPriority="high"
                className="w-full h-full object-contain pointer-events-none select-none"
            ...
            <span className="-mt-3 text-[10px] font-mono font-bold text-white group-hover:text-green-400 bg-black/70 px-2 py-0.5 rounded border border-[#24291F] tracking-wide shadow-md">
              Skills
            </span>
          </motion.div>
          ...
          {/* Trash / Decommissioned Projects Icon */}
          <motion.div
            whileHover={{ scale: 1.06 }}
            whileTap={{ scale: 0.95 }}
            onClick={(e) => { handleDockAppClick({ id: "trash", title: "Decommissioned", size: { width: 720, height: 480 } }, e); }}
            className="flex flex-col items-center gap-1.5 cursor-pointer group"
          >
            <div className="w-14 h-14 bg-[#0A0C09]/90 border border-[#3A4034]/60 group-hover:border-[#5A5E55] rounded-xl flex items-center justify-center p-2 backdrop-blur-md shadow-xl transition-all">
              <svg
                className="w-8 h-8 text-[#5A5E55] group-hover:text-[#7A8274] transition-colors"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth="1.5"
            ...
            <span className="text-[10px] font-mono font-bold text-[#5A5E55] group-hover:text-[#7A8274] bg-black/70 px-2 py-0.5 rounded border border-[#1A1D1A] tracking-wide shadow-md transition-colors">
              Trash
            </span>
          </motion.div>
        </div>
