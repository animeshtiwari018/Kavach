      ...
      >
        ...
        <div className="absolute top-[60px] left-6 z-20 flex flex-col items-center gap-6 select-none">
          ...
          <motion.div
            ...
            className="flex flex-col items-center gap-0 cursor-pointer group"
          >
            <div className="w-20 h-20 flex items-center justify-center transition-all group-hover:drop-shadow-[0_0_15px_rgba(122,130,116,0.4)]">
              <img
                src="/images/bin_optimized.webp"
                alt="Trash"
                loading="eager"
                fetchPriority="high"
                className="w-full h-full object-contain pointer-events-none select-none"
            ...
            <span className="-mt-3 text-[10px] font-mono font-bold text-[#5A5E55] group-hover:text-[#7A8274] bg-black/70 px-2 py-0.5 rounded border border-[#1A1D1A] tracking-wide shadow-md transition-colors">
              Trash
            </span>
          </motion.div>
        </div>
